...
public class MainController {
    ...
    @GetMapping("/editar")
    public String editar(HttpSession session, Model model, @RequestParam("id") String idstring, @ModelAttribute("oximetro")Oximetro oximetro, RedirectAttributes attributes){
        try{
            ...
            if(oxi != null){
                ...
                attributes.addFlashAttribute("mensaje_error", "No hay pulsioximetro con el id seleccionado");
                return "redirect:/netpulse/oximetros";
            }
        } catch (NumberFormatException e) {
            e.printStackTrace();
            attributes.addFlashAttribute("mensaje_error", "El id debe ser un numero entero");
            return "redirect:/netpulse/oximetros";
        }
    }
